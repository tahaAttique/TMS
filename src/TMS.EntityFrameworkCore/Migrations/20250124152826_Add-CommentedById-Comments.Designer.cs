...
namespace TMS.Migrations
{
    ...
    [Migration("20250124152826_Add-CommentedById-Comments")]
    partial class AddCommentedByIdComments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TMS.Comments.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TMS.TicketCategories.TicketCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TMS.Tickets.Ticket", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("NonWorkRound")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<Guid?>("SelfAssignedByUserId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SelfAssignedByUserId");
            ...
            modelBuilder.Entity("TMS.Comments.Comment", b =>
                {
                    ...
                    b.HasOne("TMS.Tickets.Ticket", "Ticket")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("TMS.Tickets.Ticket", b =>
                {
                    b.HasOne("Volo.Abp.Identity.IdentityUser", "AssignedToUser")
                        .WithMany()
                        .HasForeignKey("AssignedToUserId");

                    b.HasOne("Volo.Abp.Identity.IdentityUser", "SelfAssignedUser")
                        .WithMany()
                        .HasForeignKey("SelfAssignedByUserId");

                    b.HasOne("TMS.TicketCategories.TicketCategory", "TicketCategory")
                        .WithMany("Tickets")
